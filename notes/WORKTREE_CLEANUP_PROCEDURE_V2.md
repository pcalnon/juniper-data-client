...
- The main repo directory is accessible at `/home/pcalnon/Development/python/Juniper/juniper-data-client`
...
# Main repo
MAIN_REPO="/home/pcalnon/Development/python/Juniper/juniper-data-client"
```
...
gh pr create --repo pcalnon/juniper-data-client --base main --head "$OLD_BRANCH" \
